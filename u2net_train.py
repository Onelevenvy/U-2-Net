...
criterion = FaintDefectLoss(focal_weight=1.0, iou_weight=0.5, positive_weight=10.0, gamma=2.0)
...
if __name__ == '__main__':
    ...
    optimizer = optim.Adam(net.parameters(), lr=0.001, betas=(0.9, 0.999), eps=1e-08, weight_decay=0)  # 降低学习率减少振荡
